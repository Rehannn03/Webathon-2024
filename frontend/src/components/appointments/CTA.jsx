...
function CTA() {
  ...
  <Image class="absolute bottom-0 right-0" src="/appointment/gradient.svg" alt="" fill/>
  <div class="relative z-10 container px-4 mx-auto">
    <div class="flex flex-wrap items-center">
      <div class="w-full md:w-1/2 p-8">
        <div class="md:max-w-lg">
          <h2 class="mb-6 text-6xl md:text-7xl text-white font-bold tracking-px-n leading-tight">Consult with a Doctor</h2>
          <p class="mb-8 text-white text-opacity-70 font-medium md:max-w-md">Book an appointment with a doctor of your choice. Get a consultation at your convenience.</p>  
          <div class="flex flex-wrap -m-2">
            <div class="w-full md:w-auto p-2">
              <button class="py-4 px-6 w-full font-medium rounded-xl shadow-6xl focus:ring focus:ring-gray-300 bg-white hover:bg-gray-100 transition ease-in-out duration-200" type="button">See Plans</button>
            </div>
            <div class="w-full md:w-auto p-2">
